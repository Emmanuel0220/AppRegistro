...
import com.example.myvolley.Encriptación.Sha1;
...
public class Login extends AppCompatActivity {
            ...
            if(userName.length() > 20 || Password.length() > 30){
                ...
                try {
                    ...
                    if("Usuario Encontrado".equals(mensaje)){
                        ...
                        Intent intent = new Intent(Login.this, com.example.myvolley.Website.class);
    ...
    public void OlvidarContra (View v){
        Intent intent = new Intent (Login.this, com.example.myvolley.Forgotpass.class);
        startActivity( intent );
    }
}
...
import com.example.myvolley.Json.Cuenta;
import com.example.myvolley.Json.Info;
import com.example.myvolley.Json.Json;
import com.example.myvolley.List.MyAdapter;
import com.example.myvolley.List.MyAdapterEdit;
import com.example.myvolley.List.MyAdapterRemove;
...
public class ListMain extends AppCompatActivity {
    ...
    {
        int numArchivo = getIntent().getExtras().getInt("numArchivo");
        Intent intent1 = new Intent (ListMain.this, com.example.myvolley.EditList.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.MenuCerrarSesionrId:
                Intent intent1 = new Intent (ListMain.this, com.example.myvolley.Login.class);
                startActivity( intent1 );
                break;
            case R.id.MenuNuevoId:
                int numArchivo = getIntent().getExtras().getInt("numArchivo");
                Intent intent2 = new Intent (ListMain.this, com.example.myvolley.EditList.class);
